                ...
                <div className="flex items-start gap-4 relative">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Look at the <span className="text-tech-400 font-medium">bottom right</span> of your screen.
                            The widget tracks your presence. Try switching tabs or minimizing this window—the progress
            ...
            <div className="space-y-8">
                <section>
                    ...
                    <p className="text-slate-400 leading-relaxed">
                        ...
                        alongside window focus events. This ensures that "engagement" means you are actually looking at
                        the content, not just having the tab open in the background.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-slate-400 leading-relaxed">
                        Deep work is the ability to focus without distraction on a cognitively demanding task. It's a
                        skill that allows you to quickly master complicated information and produce better results in
                        less time. Deep work will make you better at what you do and provide the sense of true
