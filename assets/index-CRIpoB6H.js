...
`,Q=b({uTime:0,uDecay:.1,uComplex:.3,uWaves:20,uColorA:new p("#0d1b2a"),uColorB:new p("#00ffcc")},`
    varying vec2 vUv;
    ...
    `),H=b({uTime:0,uDecay:.1,uComplex:.3,uWaves:20,uColorA:new p("#ff0055"),uColorB:new p("#220033")},`
    varying vec2 vUv;
    ...
    `),U=b({uTime:0,uDecay:.1,uComplex:.3,uWaves:20,uColorA:new p("#ffffff"),uColorB:new p("#4444ff")},`
    varying float vNoise;
...
`,X=b({uTime:0,uPointScale:1,uDecay:.1,uComplex:.3,uWaves:20,uEqColor:11,uFragment:!0,uElectroflow:!0},`
    ${Z}
    ...
    `);j({FireballMaterial:X});const J=({params:t})=>{const o=s.useRef(null),n=s.useRef(null),c=s.useRef(Date.now());return z(()=>{if(o.current){const r=(Date.now()-c.current)*t.speed;o.current.uniforms.uTime.value=r,o.current.uniforms.uPointScale.value=t.pointScale,o.current.uniforms.uDecay.value=t.decay,o.current.uniforms.uComplex.value=t.complex,o.current.uniforms.uWaves.value=t.waves,o.current.uniforms.uEqColor.value=t.hue,o.current.uniforms.uFragment.value=t.fragment,o.current.uniforms.uElectroflow.value=t.electroflow}if(n.current){n.current.rotation.y+=t.velocity;const r=Date.now()*.003;n.current.rotation.x=Math.sin(r*t.sinVel)*t.ampVel*Math.PI/180}}),e.jsxs("points",{ref:n,children:[e.jsx("sphereGeometry",{args:[3,512,512]}),e.jsx("fireballMaterial",{ref:o})]})};j({ParticlesMaterial:U});const K=({params:t,fireballParams:o})=>{const n=s.useRef(null),c=s.useRef(null),r=s.useRef(Date.now()),{positions:u,randoms:f}=s.useMemo(()=>{const v=new Float32Array(6e4),x=new Float32Array(2e4);for(let g=0;g<2e4;g++){const y=Math.random()*Math.PI*2,a=Math.acos(Math.random()*2-1),l=3.5+(Math.random()-.5)*.5,h=l*Math.sin(a)*Math.cos(y),C=l*Math.sin(a)*Math.sin(y),N=l*Math.cos(a);v[g*3]=h,v[g*3+1]=C,v[g*3+2]=N,x[g]=Math.random()}return{positions:v,randoms:x}},[]);return z(()=>{if(n.current){const m=(Date.now()-r.current)*o.speed;n.current.uniforms.uTime.value=m,n.current.uniforms.uDecay.value=o.decay,n.current.uniforms.uComplex.value=o.complex,n.current.uniforms.uWaves.value=o.waves,n.current.uniforms.uColorA.value.set(t.colorA),n.current.uniforms.uColorB.value.set(t.colorB)}c.current&&(c.current.rotation.y+=o.velocity)}),e.jsxs("points",{ref:c,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[u,3]}),e.jsx("bufferAttribute",{attach:"attributes-aRandom",args:[f,1]})]}),e.jsx("particlesMaterial",{ref:n,transparent:!0,blending:L,depthWrite:!1})]})};j({SphereBlobMaterial:H});const Y=({params:t,fireballParams:o})=>{const n=s.useRef(null),c=s.useRef(null),r=s.useRef(Date.now());return z(()=>{if(n.current){const u=(Date.now()-r.current)*o.speed;n.current.uniforms.uTime.value=u,n.current.uniforms.uDecay.value=o.decay,n.current.uniforms.uComplex.value=o.complex,n.current.uniforms.uWaves.value=o.waves,n.current.uniforms.uColorA.value.set(t.colorA),n.current.uniforms.uColorB.value.set(t.colorB)}c.current&&(c.current.rotation.y+=o.velocity)}),e.jsxs("mesh",{ref:c,children:[e.jsx("icosahedronGeometry",{args:[2,64]}),e.jsx("sphereBlobMaterial",{ref:n,wireframe:t.wireframe})]})};j({TerrainMaterial:Q});const ee=({params:t,fireballParams:o})=>{const n=s.useRef(null),c=s.useRef(null),r=s.useRef(Date.now());return z(()=>{if(n.current){const u=(Date.now()-r.current)*o.speed;n.current.uniforms.uTime.value=u,n.current.uniforms.uDecay.value=o.decay,n.current.uniforms.uComplex.value=o.complex,n.current.uniforms.uWaves.value=o.waves,n.current.uniforms.uColorA.value.set(t.colorA),n.current.uniforms.uColorB.value.set(t.colorB)}c.current&&(c.current.rotation.y+=o.velocity)}),e.jsxs("mesh",{ref:c,rotation:[-Math.PI/2,0,0],children:[e.jsx("planeGeometry",{args:[10,10,128,128]}),e.jsx("terrainMaterial",{ref:n,wireframe:t.wireframe,side:S})]})},te={[i.TERRAIN]:[0,3,4],[i.SPHERE_BLOB]:[0,0,6],[i.PARTICLES]:[0,0,8],[i.FIREBALL]:[0,0,12]},oe=({effectType:t,params:o,fireballParams:n})=>{const c=te[t];return e.jsx("div",{className:"absolute top-0 left-0 w-full h-full",children:e.jsxs(A,{camera:{position:c,fov:55,near:.1,far:1e3},dpr:[1,2],gl:{antialias:!0,alpha:!1},children:[e.jsx("color",{attach:"background",args:[328965]}),e.jsx("fogExp2",{attach:"fog",args:[328965,.02]}),e.jsx(k,{enableDamping:!0,dampingFactor:.05,enableZoom:!0}),t===i.TERRAIN&&e.jsx(ee,{params:o,fireballParams:n}),t===i.SPHERE_BLOB&&e.jsx(Y,{params:o,fireballParams:n}),t===i.PARTICLES&&e.jsx(K,{params:o,fireballParams:n}),t===i.FIREBALL&&e.jsx(J,{params:n})]})})},R={[i.FIREBALL]:{colorA:"#ff5500",colorB:"#ffff00",wireframe:!1},[i.TERRAIN]:{colorA:"#0d1b2a",colorB:"#00ffcc",wireframe:!0},[i.SPHERE_BLOB]:{colorA:"#ff0055",colorB:"#220033",wireframe:!1},[i.PARTICLES]:{colorA:"#ffffff",colorB:"#4444ff",wireframe:!1}},ne={velocity:.002,speed:5e-4,pointScale:5,decay:.1,complex:.3,waves:20,hue:11,fragment:!0,electroflow:!0,sinVel:0,ampVel:80},re=()=>{const[t,o]=s.useState(i.FIREBALL),[n,c]=s.useState(R[i.FIREBALL]),[r,u]=s.useState(ne),f=m=>{o(m),c(R[m])};return e.jsxs("div",{className:"relative w-screen h-screen overflow-hidden font-sans bg-transparent",children:[e.jsx(oe,{effectType:t,params:n,fireballParams:r}),e.jsx(G,{effectType:t,params:n,setEffectType:f,setParams:c,fireballParams:r,setFireballParams:u}),e.jsxs("div",{className:"absolute bottom-6 left-6 pointer-events-none opacity-50 text-white mix-blend-difference z-10",children:[e.jsx("h2",{className:"text-4xl font-black tracking-tighter uppercase",children:t.replace("_"," ")}),e.jsx("p",{className:"text-sm tracking-widest mt-1",children:"PERLIN NOISE GENERATOR"})]})]})},xe={fullscreen:!0};function ue(){return[{title:"Perlin Noise | Carry"},{property:"og:title",content:"Perlin Noise"},{name:"description",content:"An interactive Perlin noise visualizer with terrain, sphere blob, particles, and plasma effects."}]}const de=P(re);export{de as default,xe as handle,ue as meta};
