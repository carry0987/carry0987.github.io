import{a as l,p as e,w as C}from"./chunk-WWGJGFF6-B6u1Qf49.js";import{e as m,b as g,C as P}from"./OrbitControls-2wmebMyn.js";import{s as p}from"./shaderMaterial-CmZ-zmui.js";import{g as v,x as w,A}from"./three.module-DcpnAN3g.js";import{O as R}from"./OrbitControls-CxagEG9A.js";var a=(o=>(o.TERRAIN="TERRAIN",o.SPHERE_BLOB="SPHERE_BLOB",o.PARTICLES="PARTICLES",o.PLASMA="PLASMA",o.FIREBALL="FIREBALL",o))(a||{});const y=`
...
`,E=p({uTime:0,uSpeed:.2,uNoiseScale:.8,uDisplacement:1.5,uColorA:new v("#0d1b2a"),uColorB:new v("#00ffcc")},`
    varying vec2 vUv;
    ...
    `),_=p({uTime:0,uSpeed:.5,uNoiseScale:1.5,uDisplacement:.8,uColorA:new v("#ff0055"),uColorB:new v("#220033")},`
    varying vec2 vUv;
    ...
    `),F=p({uTime:0,uSpeed:.3,uNoiseScale:1,uColorA:new v("#1a0b2e"),uColorB:new v("#ff00ff")},`
    varying vec2 vUv;
    void main() {
        vUv = uv;
    ...
    `),B=p({uTime:0,uSpeed:.1,uNoiseScale:.5,uDisplacement:2,uColorA:new v("#ffffff"),uColorB:new v("#4444ff")},`
    varying float vNoise;
...
`,L=p({uTime:0,uPointScale:1,uDecay:.1,uComplex:.3,uWaves:20,uEqColor:11,uFragment:!0,uElectroflow:!0},`
    ${M}
    ...
    `);m({TerrainMaterial:E});const I=({params:o})=>{const t=l.useRef(null),s=l.useRef(null);return g(()=>{t.current&&(t.current.uniforms.uTime.value+=.01,t.current.uniforms.uSpeed.value=o.speed,t.current.uniforms.uNoiseScale.value=o.noiseScale,t.current.uniforms.uDisplacement.value=o.displacement,t.current.uniforms.uColorA.value.set(o.colorA),t.current.uniforms.uColorB.value.set(o.colorB)),s.current&&(s.current.rotation.y+=.002)}),e.jsxs("mesh",{ref:s,rotation:[-Math.PI/2,0,0],children:[e.jsx("planeGeometry",{args:[10,10,128,128]}),e.jsx("terrainMaterial",{ref:t,wireframe:o.wireframe,side:w})]})};m({SphereBlobMaterial:_});const T=({params:o})=>{const t=l.useRef(null),s=l.useRef(null);return g(()=>{t.current&&(t.current.uniforms.uTime.value+=.01,t.current.uniforms.uSpeed.value=o.speed,t.current.uniforms.uNoiseScale.value=o.noiseScale,t.current.uniforms.uDisplacement.value=o.displacement,t.current.uniforms.uColorA.value.set(o.colorA),t.current.uniforms.uColorB.value.set(o.colorB)),s.current&&(s.current.rotation.y+=.002)}),e.jsxs("mesh",{ref:s,children:[e.jsx("icosahedronGeometry",{args:[2,64]}),e.jsx("sphereBlobMaterial",{ref:t,wireframe:o.wireframe})]})};m({PlasmaMaterial:F});const D=({params:o})=>{const t=l.useRef(null),s=l.useRef(null);return g(()=>{t.current&&(t.current.uniforms.uTime.value+=.01,t.current.uniforms.uSpeed.value=o.speed,t.current.uniforms.uNoiseScale.value=o.noiseScale,t.current.uniforms.uColorA.value.set(o.colorA),t.current.uniforms.uColorB.value.set(o.colorB)),s.current&&(s.current.rotation.y+=.002)}),e.jsxs("mesh",{ref:s,children:[e.jsx("planeGeometry",{args:[8,8,32,32]}),e.jsx("plasmaMaterial",{ref:t,side:w,wireframe:o.wireframe})]})};m({ParticlesMaterial:B});const V=({params:o})=>{const t=l.useRef(null),s=l.useRef(null),{positions:x,randoms:r}=l.useMemo(()=>{const c=new Float32Array(6e4),i=new Float32Array(2e4);for(let u=0;u<2e4;u++){const n=Math.random()*Math.PI*2,d=Math.acos(Math.random()*2-1),h=3.5+(Math.random()-.5)*.5,z=h*Math.sin(d)*Math.cos(n),N=h*Math.sin(d)*Math.sin(n),S=h*Math.cos(d);c[u*3]=z,c[u*3+1]=N,c[u*3+2]=S,i[u]=Math.random()}return{positions:c,randoms:i}},[]);return g(()=>{t.current&&(t.current.uniforms.uTime.value+=.01,t.current.uniforms.uSpeed.value=o.speed,t.current.uniforms.uNoiseScale.value=o.noiseScale,t.current.uniforms.uDisplacement.value=o.displacement,t.current.uniforms.uColorA.value.set(o.colorA),t.current.uniforms.uColorB.value.set(o.colorB)),s.current&&(s.current.rotation.y+=.002)}),e.jsxs("points",{ref:s,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[x,3]}),e.jsx("bufferAttribute",{attach:"attributes-aRandom",args:[r,1]})]}),e.jsx("particlesMaterial",{ref:t,transparent:!0,blending:A,depthWrite:!1})]})};m({FireballMaterial:L});const k=({params:o})=>{const t=l.useRef(null),s=l.useRef(null),x=l.useRef(Date.now());return g(()=>{if(t.current){const r=(Date.now()-x.current)*o.speed;t.current.uniforms.uTime.value=r,t.current.uniforms.uPointScale.value=o.pointScale,t.current.uniforms.uDecay.value=o.decay,t.current.uniforms.uComplex.value=o.complex,t.current.uniforms.uWaves.value=o.waves,t.current.uniforms.uEqColor.value=o.hue,t.current.uniforms.uFragment.value=o.fragment,t.current.uniforms.uElectroflow.value=o.electroflow}if(s.current){s.current.rotation.y+=o.velocity;const r=Date.now()*.003;s.current.rotation.x=Math.sin(r*o.sinVel)*o.ampVel*Math.PI/180}}),e.jsxs("points",{ref:s,children:[e.jsx("icosahedronGeometry",{args:[3,7]}),e.jsx("fireballMaterial",{ref:t})]})},O={[a.TERRAIN]:[0,3,4],[a.SPHERE_BLOB]:[0,0,6],[a.PARTICLES]:[0,0,8],[a.PLASMA]:[0,0,5],[a.FIREBALL]:[0,0,12]},q=({effectType:o,params:t,fireballParams:s})=>{const x=O[o];return e.jsx("div",{className:"absolute top-0 left-0 w-full h-full",children:e.jsxs(P,{camera:{position:x,fov:55,near:.1,far:1e3},dpr:[1,2],gl:{antialias:!0,alpha:!1},children:[e.jsx("color",{attach:"background",args:[328965]}),e.jsx("fogExp2",{attach:"fog",args:[328965,.02]}),e.jsx(R,{enableDamping:!0,dampingFactor:.05,enableZoom:!0}),o===a.TERRAIN&&e.jsx(I,{params:t}),o===a.SPHERE_BLOB&&e.jsx(T,{params:t}),o===a.PLASMA&&e.jsx(D,{params:t}),o===a.PARTICLES&&e.jsx(V,{params:t}),o===a.FIREBALL&&s&&e.jsx(k,{params:s})]})})},U=({effectType:o,params:t,setEffectType:s,setParams:x,fireballParams:r,setFireballParams:f})=>{const c=(n,d)=>{x({...t,[n]:d})},i=(n,d)=>{f({...r,[n]:d})},u=Object.values(a);return e.jsxs("div",{className:"absolute top-4 right-4 w-80 bg-black/60 backdrop-blur-md border border-white/10 rounded-xl p-6 text-white shadow-2xl overflow-y-auto max-h-[90vh] z-20",children:[e.jsxs("div",{className:"mb-6",children:[e.jsx("h1",{className:"text-xl font-bold bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-1",children:"Noise Lab"}),e.jsx("p",{className:"text-xs text-gray-400",children:"Interactive Perlin Experiments"})]}),e.jsxs("div",{className:"mb-6",children:[e.jsx("label",{className:"block text-xs uppercase tracking-wider text-gray-500 mb-2 font-semibold",children:"Mode"}),e.jsx("div",{className:"grid grid-cols-2 gap-2",children:u.map(n=>e.jsx("button",{onClick:()=>s(n),className:`px-3 py-2 rounded-lg text-xs font-medium transition-all duration-200 border ${o===n?"bg-white/20 border-white/40 text-white shadow-[0_0_10px_rgba(255,255,255,0.2)]":"bg-transparent border-white/5 text-gray-400 hover:bg-white/5 hover:text-gray-200"}`,children:n.replace("_"," ")},n))})]}),e.jsxs("div",{className:"space-y-5",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Speed"}),e.jsx("span",{className:"text-xs text-gray-500",children:t.speed.toFixed(2)})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.01",value:t.speed,onChange:n=>c("speed",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-purple-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Noise Scale"}),e.jsx("span",{className:"text-xs text-gray-500",children:t.noiseScale.toFixed(2)})]}),e.jsx("input",{type:"range",min:"0.1",max:"5.0",step:"0.1",value:t.noiseScale,onChange:n=>c("noiseScale",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Displacement / Intensity"}),e.jsx("span",{className:"text-xs text-gray-500",children:t.displacement.toFixed(2)})]}),e.jsx("input",{type:"range",min:"0",max:"3",step:"0.1",value:t.displacement,onChange:n=>c("displacement",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-pink-500"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 pt-2",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-xs text-gray-300 mb-2",children:"Color A"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{type:"color",value:t.colorA,onChange:n=>c("colorA",n.target.value),className:"w-full h-8 rounded cursor-pointer opacity-0 absolute top-0 left-0"}),e.jsx("div",{className:"w-full h-8 rounded border border-white/20",style:{backgroundColor:t.colorA}})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-xs text-gray-300 mb-2",children:"Color B"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{type:"color",value:t.colorB,onChange:n=>c("colorB",n.target.value),className:"w-full h-8 rounded cursor-pointer opacity-0 absolute top-0 left-0"}),e.jsx("div",{className:"w-full h-8 rounded border border-white/20",style:{backgroundColor:t.colorB}})]})]})]}),o!==a.PARTICLES&&o!==a.FIREBALL&&e.jsxs("div",{className:"flex items-center justify-between pt-2",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Wireframe Mode"}),e.jsx("button",{onClick:()=>c("wireframe",!t.wireframe),className:`w-10 h-5 rounded-full relative transition-colors duration-300 ${t.wireframe?"bg-purple-600":"bg-gray-700"}`,children:e.jsx("div",{className:`w-3 h-3 bg-white rounded-full absolute top-1 transition-transform duration-300 ${t.wireframe?"left-6":"left-1"}`})})]}),o===a.FIREBALL&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"border-t border-white/10 pt-4 mt-4",children:e.jsx("h3",{className:"text-xs uppercase tracking-wider text-orange-400 mb-4 font-semibold",children:"Fireball Settings"})}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Velocity"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.velocity.toFixed(4)})]}),e.jsx("input",{type:"range",min:"0",max:"0.02",step:"0.0001",value:r.velocity,onChange:n=>i("velocity",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-orange-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Speed"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.speed.toFixed(5)})]}),e.jsx("input",{type:"range",min:"0",max:"0.0005",step:"0.00001",value:r.speed,onChange:n=>i("speed",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-orange-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Point Size"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.pointScale.toFixed(1)})]}),e.jsx("input",{type:"range",min:"1",max:"5",step:"0.1",value:r.pointScale,onChange:n=>i("pointScale",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-yellow-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Decay"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.decay.toFixed(2)})]}),e.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:r.decay,onChange:n=>i("decay",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-red-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Complexity"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.complex.toFixed(2)})]}),e.jsx("input",{type:"range",min:"0.1",max:"1",step:"0.01",value:r.complex,onChange:n=>i("complex",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-purple-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Waves"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.waves.toFixed(1)})]}),e.jsx("input",{type:"range",min:"0",max:"20",step:"0.5",value:r.waves,onChange:n=>i("waves",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-blue-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Hue"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.hue.toFixed(1)})]}),e.jsx("input",{type:"range",min:"0",max:"15",step:"0.1",value:r.hue,onChange:n=>i("hue",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-pink-500"})]}),e.jsx("div",{className:"border-t border-white/10 pt-4 mt-4",children:e.jsx("h3",{className:"text-xs uppercase tracking-wider text-cyan-400 mb-4 font-semibold",children:"Spin Settings"})}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Sine"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.sinVel.toFixed(2)})]}),e.jsx("input",{type:"range",min:"0",max:"0.5",step:"0.01",value:r.sinVel,onChange:n=>i("sinVel",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-cyan-500"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex justify-between mb-1",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Amplitude"}),e.jsx("span",{className:"text-xs text-gray-500",children:r.ampVel.toFixed(1)})]}),e.jsx("input",{type:"range",min:"0",max:"90",step:"1",value:r.ampVel,onChange:n=>i("ampVel",parseFloat(n.target.value)),className:"w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-cyan-500"})]}),e.jsxs("div",{className:"space-y-3 pt-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Fragment Mode"}),e.jsx("button",{onClick:()=>i("fragment",!r.fragment),className:`w-10 h-5 rounded-full relative transition-colors duration-300 ${r.fragment?"bg-orange-600":"bg-gray-700"}`,children:e.jsx("div",{className:`w-3 h-3 bg-white rounded-full absolute top-1 transition-transform duration-300 ${r.fragment?"left-6":"left-1"}`})})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("label",{className:"text-xs text-gray-300",children:"Electroflow"}),e.jsx("button",{onClick:()=>i("electroflow",!r.electroflow),className:`w-10 h-5 rounded-full relative transition-colors duration-300 ${r.electroflow?"bg-purple-600":"bg-gray-700"}`,children:e.jsx("div",{className:`w-3 h-3 bg-white rounded-full absolute top-1 transition-transform duration-300 ${r.electroflow?"left-6":"left-1"}`})})]})]})]})]})]})},b={[a.TERRAIN]:{speed:.2,noiseScale:.8,displacement:1.5,colorA:"#0d1b2a",colorB:"#00ffcc",wireframe:!0},[a.SPHERE_BLOB]:{speed:.5,noiseScale:1.5,displacement:.8,colorA:"#ff0055",colorB:"#220033",wireframe:!1},[a.PARTICLES]:{speed:.1,noiseScale:.5,displacement:2,colorA:"#ffffff",colorB:"#4444ff",wireframe:!1},[a.PLASMA]:{speed:.3,noiseScale:1,displacement:1,colorA:"#1a0b2e",colorB:"#ff00ff",wireframe:!1},[a.FIREBALL]:{speed:1,noiseScale:1,displacement:2,colorA:"#ff5500",colorB:"#ffff00",wireframe:!1}},j={velocity:.002,speed:5e-4,pointScale:1,decay:.1,complex:.3,waves:20,hue:11,fragment:!0,electroflow:!0,sinVel:0,ampVel:80},$=()=>{const[o,t]=l.useState(a.TERRAIN),[s,x]=l.useState(b[a.TERRAIN]),[r,f]=l.useState(j),c=i=>{t(i),x(b[i]),i===a.FIREBALL&&f(j)};return e.jsxs("div",{className:"relative w-screen h-screen overflow-hidden font-sans bg-transparent",children:[e.jsx(q,{effectType:o,params:s,fireballParams:o===a.FIREBALL?r:void 0}),e.jsx(U,{effectType:o,params:s,setEffectType:c,setParams:x,fireballParams:r,setFireballParams:f}),e.jsxs("div",{className:"absolute bottom-6 left-6 pointer-events-none opacity-50 text-white mix-blend-difference z-10",children:[e.jsx("h2",{className:"text-4xl font-black tracking-tighter uppercase",children:o.replace("_"," ")}),e.jsx("p",{className:"text-sm tracking-widest mt-1",children:"PERLIN NOISE GENERATOR"})]})]})},J={fullscreen:!0};function K(){return[{title:"Perlin Noise | Carry"},{property:"og:title",content:"Perlin Noise"},{name:"description",content:"An interactive Perlin noise visualizer with terrain, sphere blob, particles, and plasma effects."}]}const X=C($);export{X as default,J as handle,K as meta};
